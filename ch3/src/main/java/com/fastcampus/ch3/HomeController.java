...
// ApplicationContextTest 실행시 오류 나서 주석처리
//@Controller
public class HomeController {
	...
	public String home(Locale locale, HttpServletRequest request, Model model) {
		...
		System.out.println("rootAC.getBeanDefinitionNames() = " + Arrays.toString(rootAC.getBeanDefinitionNames())); // root-context.xml
		System.out.println("servletAC.getBeanDefinitionNames() = " + Arrays.toString(servletAC.getBeanDefinitionNames())); // servlet-context.xml
...
//		WebApplicationContextUtils.getWebApplicationContext(sc); 로 AC 를 가져올 수도 있지만 
//		@Autowired WebApplicationContext 의 부모가 rootAC 임
